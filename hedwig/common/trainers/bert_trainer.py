...
class BertTrainer(object):
    def __init__(self, model, optimizer, processor, args):
        ...
        self.log_template = ' '.join('{:>5.0f},{:>9.0f},{:>6.0f}/{:<5.0f} {:>6.4f},{:>8.4f},{:8.4f},{:8.4f},{:>8.4f},{:8.4f},{:8.4f},{:10.4f}'.split(','))
    ...
    def train_epoch(self, train_dataloader):
        for step, batch in enumerate(tqdm(train_dataloader, desc="Training")):
            ...
            if self.args.is_multilabel:
                if self.args.fp16:
                    loss = F.binary_cross_entropy_with_logits(logits, label_ids.half())
                else:
    ...
    def train(self):
        ...
        for epoch in trange(int(self.args.epochs), desc="Epoch"):
            ...
            dev_acc, dev_hamming, dev_jaccard, dev_precision, dev_recall, dev_f1_micro, dev_f1_macro, dev_loss = self.dev_evaluator.get_scores()[0]
            # Print validation results
            tqdm.write(self.log_header)
            tqdm.write(self.log_template.format(epoch + 1, self.iterations, epoch + 1, self.args.epochs,  dev_acc, dev_hamming, dev_jaccard, dev_precision, dev_recall,
